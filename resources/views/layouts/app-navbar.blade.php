<section class="jumbotron  pt-4">
    <nav class="max-w-screen-xl text-white mx-auto mb-10 w-full content-between items-center px-4 sm:mb-16 md:mt-4 lg:relative lg:flex">
        <div class="flex content-between items-center">
            <a href="{{ url('/') }}" class="w-52 lg:w-60" title="Service Provider Pro">
                <img src="{{ asset('assets/images/images-logo_inverse.svg') }}" class="logo-dark" title="Service Provider Pro" alt="SPP inverse logo">
            </a>



            <button type="button" class="ml-auto h-6 w-6 lg:hidden" id="toggler" data-target="#collapsible-menu" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="hidden w-full justify-end pt-5 lg:flex lg:pt-0" id="collapsible-menu">
            <ul class="items-center lg:flex">
                ...
                <li class="my-4 text-center lg:my-0">
                    <a href="#" class="whitespace-nowrap px-4 text-sm font-medium opacity-70" data-submenu="#industries">
                        Use Cases
                    </a>
                </li>
                ...
                <li class="my-4 text-center lg:my-0">
                    <a href="{{ url('pricing') }}" class="px-4 text-sm font-medium opacity-70">
                        Pricing
                    </a>
                </li>
            ...
            <div>
                <div class="mx-4 hidden overflow-hidden rounded transition-all duration-200 sm:mx-0" id="features">
                    <div class="grid gap-4 bg-white p-4 sm:grid-cols-2">
                            ...
                            <div class="flex items-start gap-x-5">
                                <div class="flex h-10 w-10 flex-none items-center justify-center rounded-lg bg-gray-100 group-hover:bg-white">
                                    <svg class="h-5 w-5 text-blue-700" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 448 512">
                                        ...
                                        <path class="fa-secondary" d="M352 128A128 128 0 1 1 96 128a128 128 0 1 1 256 0z"></path>
                                        <path class="fa-primary" d="M190.5 328.2l18.6 31L175.8 483.1l-36-146.9c-2-8.1-9.8-13.4-17.9-11.3C51.9 342.4 0 405.8 0 481.3c0 17 13.8 30.7 30.7 30.7H162.5c2.1 0 4-.4 5.8-1.1L168 512H280l-.3-1.1c1.8 .7 3.8 1.1 5.8 1.1H417.3c17 0 30.7-13.8 30.7-30.7c0-75.5-51.9-138.9-121.9-156.4c-8.1-2-15.9 3.3-17.9 11.3l-36 146.9L238.9 359.2l18.6-31c6.4-10.7-1.3-24.2-13.7-24.2H224 204.3c-12.4 0-20.1 13.6-13.7 24.2z">
                                        </path>
                                    </svg>
                                </div>
                        ...
                        <a class="group block rounded px-3 py-2 transition-all hover:bg-gray-100" href="{{ url('features/helpdesk') }}" icon="fad-life-ring" title="Helpdesk" description="Support your customers with full context of their past activity.">
                            <div class="flex items-start gap-x-5">
                                <div class="flex h-10 w-10 flex-none items-center justify-center rounded-lg bg-gray-100 group-hover:bg-white">
                                    <svg class="h-5 w-5 text-blue-700" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 512 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <defs>
                                            <style>
                                                .fa-secondary {
                        ...
                        <a class="group block rounded px-3 py-2 transition-all hover:bg-gray-100" href="{{ url('features/form-builder') }}" icon="fad-square-list" title="Forms" description="Build forms with drag &amp; drop, rules, e-signatures, and file uploads.">
                            <div class="flex items-start gap-x-5">
                                <div class="flex h-10 w-10 flex-none items-center justify-center rounded-lg bg-gray-100 group-hover:bg-white">
                                    <svg class="h-5 w-5 text-blue-700" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 448 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        ...
                                        <path class="fa-secondary" d="M0 96C0 60.7 28.7 32 64 32H384c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zM96 288a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm32-128a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM96 384a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm96-248c-13.3 0-24 10.7-24 24s10.7 24 24 24H352c13.3 0 24-10.7 24-24s-10.7-24-24-24H192zM168 352c0 13.3 10.7 24 24 24H352c13.3 0 24-10.7 24-24s-10.7-24-24-24H192c-13.3 0-24 10.7-24 24zm24-120c-13.3 0-24 10.7-24 24s10.7 24 24 24H352c13.3 0 24-10.7 24-24s-10.7-24-24-24H192z">
                                        </path>
                                        <path class="fa-primary" d="M168 160c0-13.3 10.7-24 24-24H352c13.3 0 24 10.7 24 24s-10.7 24-24 24H192c-13.3 0-24-10.7-24-24zm0 192c0-13.3 10.7-24 24-24H352c13.3 0 24 10.7 24 24s-10.7 24-24 24H192c-13.3 0-24-10.7-24-24zm24-120H352c13.3 0 24 10.7 24 24s-10.7 24-24 24H192c-13.3 0-24-10.7-24-24s10.7-24 24-24z">
                                        </path>
                                    </svg>
                                </div>
                        ...
                        <a class="group block rounded px-3 py-2 transition-all hover:bg-gray-100" href="{{ url('features/affiliates') }}" icon="fad-share-all" title="Affiliates" description="Boost word of mouth with a built-in referral program.">
                            <div class="flex items-start gap-x-5">
                                <div class="flex h-10 w-10 flex-none items-center justify-center rounded-lg bg-gray-100 group-hover:bg-white">
                                    <svg class="h-5 w-5 text-blue-700" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 576 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        ...
                                        <path class="fa-secondary" d="M371 34.8c-11.5 5.1-19 16.6-19 29.2v43.3l85.4 76.9c6.7 6.1 10.6 14.7 10.6 23.8s-3.8 17.7-10.6 23.8L352 308.7V352c0 12.6 7.4 24.1 19 29.2s25 3 34.4-5.4l160-144c6.7-6.1 10.6-14.7 10.6-23.8s-3.8-17.7-10.6-23.8l-160-144c-9.4-8.5-22.9-10.6-34.4-5.4z">
                                        </path>
                        ...
                        <a class="group block rounded px-3 py-2 transition-all hover:bg-gray-100" href="analytics.html" icon="fad-chart-mixed" title="Analytics" description="Find your best clients. See how your team is doing.">
                            <div class="flex items-start gap-x-5">
                                <div class="flex h-10 w-10 flex-none items-center justify-center rounded-lg bg-gray-100 group-hover:bg-white">
                                    <svg class="h-5 w-5 text-blue-700" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 512 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        ...
                        <a class="group block rounded px-3 py-2 transition-all hover:bg-gray-100" href="email.html" icon="fad-envelopes" title="Email" description="Send automated transactional emails and receive client replies.">
                            <div class="flex items-start gap-x-5">
                                <div class="flex h-10 w-10 flex-none items-center justify-center rounded-lg bg-gray-100 group-hover:bg-white">
                                    <svg class="h-5 w-5 text-blue-700" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 576 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        ...
                                        <path class="fa-secondary" d="M96.7 86.7l220 163c5.6 4.1 12.4 6.4 19.3 6.4s13.7-2.2 19.3-6.4l220-163C570.8 55.7 544.2 32 512 32H160c-32.2 0-58.8 23.7-63.3 54.7zM576 126L374.4 275.3C363.3 283.6 349.8 288 336 288s-27.3-4.4-38.4-12.7L96 126V320c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V126z">
                                        </path>
                                        <path class="fa-primary" d="M96 96v30L297.6 275.3c11.1 8.2 24.6 12.7 38.4 12.7s27.3-4.4 38.4-12.7L576 126V96c0-3.2-.2-6.3-.7-9.3l-220 163c-5.6 4.1-12.4 6.4-19.3 6.4s-13.7-2.2-19.3-6.4l-220-163c-.4 3-.7 6.2-.7 9.3zM48 120c0-13.3-10.7-24-24-24S0 106.7 0 120V344c0 75.1 60.9 136 136 136H456c13.3 0 24-10.7 24-24s-10.7-24-24-24H136c-48.6 0-88-39.4-88-88V120z">
                                        </path>
                                    </svg>
                                </div>
                ...
                <div class="hidden overflow-hidden rounded transition-all duration-200" id="industries">
                    <div class="top-section bg-white">
                        <div class="flex-auto px-6 py-4">
                            <a class="block py-2 opacity-90 transition-all hover:opacity-100" href="seo-agencies.html">
                            ...
                            <a class="block py-2 opacity-90 transition-all hover:opacity-100" href="content-agencies.html">
                                <div class="flex items-center">
                                    <svg class="mr-2 h-5 w-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 512 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <defs>
                ...
                <div class="hidden overflow-hidden rounded transition-all duration-200" id="resources">
                    <div class="top-section bg-white">
                        <div class="flex-auto px-6 py-4">
                            <a href="getting-started.html" class="block py-2 opacity-90 transition-all hover:opacity-100">
                                <div class="flex items-center">
                                    <svg class="mr-2 w-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 576 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <defs>
                                            <style>
                                                .fa-secondary {
                            ...
                            <a href="onboarding.html" class="block py-2 opacity-90 transition-all hover:opacity-100">
                                <div class="flex items-center">
                                    <svg class="mr-2 w-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 512 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <defs>
                                            <style>
                                                .fa-secondary {
                                        ...
                                        <path class="fa-secondary" d="M198.6 130c-28.5 45.8-60.7 114.5-80.1 158H24c-8.7 0-16.7-4.7-20.9-12.2s-4.1-16.8 .4-24.2l52.8-86.9C69.3 143.2 92.6 130 117.8 130h80.8zM224 391.8c43.9-19.1 112.4-50.3 158-78.4v80.8c0 25.2-13.1 48.5-34.6 61.5l-86.9 52.8c-7.4 4.5-16.7 4.7-24.2 .4s-12.2-12.2-12.2-20.9l0-96.2z">
                                        </path>
                                        <path class="fa-primary" d="M166.5 394.8l-50.7-50.7c-9.2-9.2-11.9-23-6.7-34.9c18.3-41.9 62.7-140.2 98.1-192.5C289.1-4.1 411.1-8.1 483.9 5.3c11.6 2.1 20.6 11.2 22.8 22.8c13.4 72.9 9.3 194.8-111.4 276.7C342.6 340.5 243 383.9 201 401.7c-11.8 5-25.4 2.2-34.5-6.9zM384 168a40 40 0 1 0 0-80 40 40 0 1 0 0 80z">
                                        </path>
                                    </svg>
                            ...
                            <a href="productize-ebook.html" class="block py-2 opacity-90 transition-all hover:opacity-100">
                                <div class="flex items-center">
                                    <svg class="mr-2 w-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 448 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <defs>
                                            <style>
                                                .fa-secondary {
                            ...
                            <a href="case-studies.html" class="block py-2 opacity-90 transition-all hover:opacity-100">
                                <div class="flex items-center">
                                    <svg class="mr-2 w-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 640 512">
                                        <!--! Font Awesome Pro 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <defs>
                                            <style>
                                                .fa-secondary {
                                        ...
                                        <path class="fa-secondary" d="M325.6 139.8c8.3-3.1 12.5-12.3 9.4-20.6s-12.3-12.5-20.6-9.4L154.9 169.6C92.4 193.1 50.4 251.8 48.1 318.2c-.1 .6-.1 1.2-.1 1.8c0 28.4-10.8 57.8-22.3 80.8c-6.5 13-13.9 25.8-22.5 37.6C0 442.7-.9 448.3 .9 453.4s6 8.9 11.2 10.2l64 16c4.2 1.1 8.7 .3 12.4-2s6.3-6.1 7.1-10.4c8.6-42.8 4.3-81.2-2.1-108.7c-3.2-14-7.5-28.3-13.4-41.5c2.8-52.5 36.4-98.7 86-117.3l159.4-59.8z">
                                        </path>
                                        <path class="fa-primary" d="M320 32c-8.1 0-16.1 1.4-23.7 4.1L15.8 137.4C6.3 140.9 0 149.9 0 160s6.3 19.1 15.8 22.6l77.4 27.9c16.8-17.8 37.8-31.9 61.7-40.9l159.4-59.8c8.3-3.1 17.5 1.1 20.6 9.4s-1.1 17.5-9.4 20.6L166.2 199.6c-14.6 5.5-27.8 13.4-39.3 23.1l169.5 61.2c7.6 2.7 15.6 4.1 23.7 4.1s16.1-1.4 23.7-4.1L624.2 182.6c9.5-3.4 15.8-12.5 15.8-22.6s-6.3-19.1-15.8-22.6L343.7 36.1C336.1 33.4 328.1 32 320 32zM128 408c0 35.3 86 72 192 72s192-36.7 192-72L496.7 262.6 354.5 314c-11.1 4-22.8 6-34.5 6s-23.5-2-34.5-6L143.3 262.6 128 408z">
                                        </path>
                                    </svg>
