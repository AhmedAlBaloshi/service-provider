...
function DMC() {
  ...
  e.addEventListener("mouseenter", () => pMT(), !1),
    e.addEventListener("mouseleave", () => vTM(), !1),
    document.querySelectorAll("a[data-submenu]").forEach((o) => {
      o.addEventListener("mouseleave", () => v(), !1),
        o.addEventListener("click", (n) => {
          ...
          return window.getComputedStyle(l).opacity == 0 ? tLP(o) : dTV();
        }),
        r.forEach((n) =>
...
function xt(t, e) {
  ...
  return (
    e.reference[i] > e.floating[i] && (s = N(s)),
    {
      main: s,
      cross: N(s),
    }
...
function F(t) {
  const { overflow: e, overflowX: n, overflowY: o } = V(t);
...
function st(t) {
  return S(R(t)).left + j(t).scrollLeft;
}
function Rt(t) {
  const e = S(t);
...
function Z(t) {
  return !CTD(t) || getComputedStyle(t).position === "fixed"
    ? null
    : t.offsetParent;
}
function Ot(t) {
  let e = X(t);
  for (; CTD(e) && !["html", "body"].includes(v(e)); ) {
    if (ct(e)) return e;
    e = e.parentNode;
  }
  return null;
...
function _(t) {
  ...
  return n &&
    (v(n) === "html" ||
      (v(n) === "body" && getComputedStyle(n).position === "static" && !ct(n)))
    ? e
    : n || Ot(t) || e;
}
function tt(t) {
...
function Et(t) {
  ...
  return {
    ...e,
    x: e.x - c.scrollLeft + r.x,
    y: e.y - c.scrollTop + r.y,
  };
}
function St(t) {
  const e = P(t),
...
function ft(t, e) {
  ...
  const o = lt(t),
    ...
    s = P(o),
    c = i ? [s].concat(s.visualViewport || [], F(o) ? o : []) : o,
    r = e.concat(c);
...
function et(t, e) {
  return e === "viewport" ? I(St(t)) : B(e) ? Dt(e) : I(Tt(R(t)));
}
function Lt(t) {
  const e = ft(X(t)),
    o = ["absolute", "fixed"].includes(V(t).position) && CTD(t) ? _(t) : t;
  return B(o) ? e.filter((i) => B(i) && kt(i, o) && v(i) !== "body") : [];
}
function Wt(t) {
